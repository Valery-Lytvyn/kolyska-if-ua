...
export const navItems: NavItem[] = [
  { item: "Головна", href: "/", icon: <IoHomeOutline /> },
  { item: "Про нас", href: "/about", icon: <BsInfoLg /> },
  { item: "Доставка", href: "/delivery", icon: <TbTruckDelivery /> },
  { item: "Оплата", href: "/payment", icon: <IoCardOutline /> },
  { item: "Контакти", href: "/contact", icon: <RiContactsBook3Line /> },
];
...
export const categoryMap: Record<string, string> = {
  ...
  манежі: "playpens",
  "дитячі шезлонги": "childrens-chaise-lounges",
...
export const categorySlugToIdMap = {
  "all-strollers": ["42772", "11082"], // Візочки 2в1 та прогулянкові
  "universal-strollers": ["42772"], // Візочки 2в1
  ...
  "childrens-chaise-lounges": ["50591"], // Шезлонги
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    href: "all-strollers",
    children: [
      { title: "Візочки 2в1", href: "universal-strollers" },
      { title: "Візочки прогулянкові", href: "strollers" },
    ],
  },
  {
    ...
    children: [
      ...
      { title: "Велосипеди триколісні", href: "three-wheels" },
  ...
  },
  {
    ...
    href: "nursery",
    children: [
      { title: "Дитячі ліжечка", href: "cribs-and-mattresses" },
      { title: "Крісла для годування", href: "feeding-chairs" },
      { title: "Манежі", href: "playpens" },
      { title: "Шезлонги", href: "childrens-chaise-lounges" },
